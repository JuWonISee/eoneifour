...
public class Config {
	...
	public static final String[][] PAGEKEYS = { 
			{ "ADMIN_REGISTER", "ADMIN_EDIT", "ADMIN_DELETE" },
			{ "INBOUND_ORDER", "OUTBOUND_ORDER", "PRODUCT_LOOKUP" }, 
			{ "INBOUND_HISTORY", "OUTBOUND_HISTORY" },
			{ "INVENTORY_UPDATE" }, 
			{ "ALL_INBOUND_RATE", "STACKER_INBOUND_RATE" }, 
			{ "RACK_INBOUND_STATUS", "INBOUND_BY_PRODUCT", "INBOUND_BY_DATE", "CANCELLED_INBOUND_ORDERS", "OUTBOUND_BY_PRODUCT" },
