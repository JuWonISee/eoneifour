...
public class Config {
	...
	public static final String[][] PAGENAME = {
			...
			{ "재고 수정" },
			{ "전체 입고율", "스태커 입고율" }, 
			{ "렉별 입고상태 조회", "제품별 입고 조회", "날짜별 입고 조회", "입고 물품 중 주문 취소 조회"},
			{ "제품별 출고 조회","날짜별 출고 조회"},
			{ "창고 모니터링", "입고상태 동기화" }
			};
	...
	/* 입고 조회  */	{ "RACK_INBOUND_STATUS", "INBOUND_BY_PRODUCT", "INBOUND_BY_DATE", "CANCELLED_INBOUND_ORDERS"}, 
	/* 출고 조회  */	{ "OUTBOUND_BY_PRODUCT", "OUTBOUND_BY_DATE"},
	/* 모니터링   */	{ "MONITORING", "INBOUND_SYNC" }
				};
};
