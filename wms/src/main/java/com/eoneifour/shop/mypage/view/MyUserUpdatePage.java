...
public class MyUserUpdatePage extends JPanel{
	...
	public MyUserUpdatePage(ShopMainFrame mainFrame) {
    ...
    public void updateUser() {
    	try {
			User user = new User();
			user.setUserId(mainFrame.userId);
    ...
    public boolean validateForm() {
        ...
        if (nameField.getText().trim().isEmpty()) return showErrorMessage("이름을 입력해주세요.");
