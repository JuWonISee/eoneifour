...
public class ProductMenuPanel extends JPanel {
	...
	public ProductMenuPanel(ShopMainFrame mainFrame) {
		...
		for(int i =0; i < Config.CATEGORYNAME.length; i++) {
			...
			JButton button = createMenuButton(category, categoryKey);
			if ("전체".equals(category)) allBtn = button; //  "전체" 버튼 저장
	...
	public JButton createMenuButton(String title, String pageKey) {
