...
public class RegistModalDialog extends AbstractModalDialog{
	private JLabel label;
    public RegistModalDialog(JFrame parent) {
        super(parent, "상품 등록"); //parent는 나중에 mainframe으로 지정.
        setSize(400, 180); // 여기서 높이 줄이기
        initComponents();
    }
    
    protected void initComponents() {
    	label = new JLabel("정말 등록 하시겠습니까?");
